...
const cards = [
  ...
  },
  {
    ...
    title: "The Green Revolution: How EcoStart Disrupted Traditional Manufacturing",
    ...
    <section ref={sectionRef} className="animate-fade-in bg-indigo-600 py-20 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="text-white lg:sticky lg:top-20 space-y-8">
          <div>
            <h1 className="text-4xl font-bold mb-4 font-literal">Business Frontiers: This Month's Defining Moments</h1>
            <h2 className="text-2xl text-cool-gray-200 font-semibold mb-6 opacity-90">
              From billion-dollar pivots to grassroots market shifts - witness the strategies reshaping industries
            </h2>
            <p className="text-lg text-cool-gray-200 mb-8">
              Explore unfiltered case studies of leadership decisions that created measurable impact across global markets and local ecosystems.
            </p>
          </div>

          <div className="space-y-6">
            <h3 className="text-xl font-medium">Behind Every Business Breakthrough is</h3>
        ...
        <div 
          ...
          className="relative lg:h-[80vh] lg:overflow-y-auto no-scrollbar lg:pr-4"
        >
                  ...
                  <div className="flex justify-between items-center mb-5 mt-2">
                    <div className="flex space-x-4 text-gray-500">
                      <span className="flex items-center space-x-1">
                        ...
                        <span className="text-xs">{card.views.toLocaleString()}</span>
                      </span>
                      <span className="flex items-center space-x-1">
                      ...
                      <span className="flex items-center space-x-1">
                        ...
                        <span className="text-xs">{card.likes.toLocaleString()}</span>
                      </span>
                    </div>
